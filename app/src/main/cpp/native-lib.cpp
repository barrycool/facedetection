...
Java_com_mtk_facedetction_MainActivity_stringFromJNI(
        JNIEnv *env,
        jobject /* this */) {
...
Java_com_mtk_facedetction_MainActivity_TengineWrapperInit(
        JNIEnv *env,
        jobject /* this */) {
...
JNIEXPORT jint JNICALL
Java_com_mtk_facedetction_MainActivity_TengineWrapperRelease(
        JNIEnv *env,
        jobject /* this */) {
...
JNIEXPORT jint JNICALL
Java_com_mtk_facedetction_MainActivity_RunMobilenetFromFile(
        JNIEnv *env,
...
JNIEXPORT jint JNICALL
Java_com_mtk_facedetction_MainActivity_RunMobilenet(
        JNIEnv *env,
...
JNIEXPORT jstring JNICALL
Java_com_mtk_facedetction_MainActivity_TengineWrapperGetTop1(
        JNIEnv *env,
        jobject /* this */) {
